...
def main():
    ...
    plt.fill_between([-1, 1], y1=0.5, y2=1, color="tab:red", alpha=0.7)
    plt.fill_between([-1, 0.25], y1=-1, y2=0.5, color="tab:green", alpha=0.7)
    plt.fill_between([0.25, 1], y1=-1, y2=0.5, color="tab:blue", alpha=0.7)
